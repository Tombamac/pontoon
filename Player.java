...
public class Player {
	...
	/**
	 * The number of chards in the player's current hand.
	 */
	...
	/**
	 * Reset the plyaer's hand to have no cards.
	 */
	public void emptyHand()
	{
		...
		public int getHandSum()
		{
			...
			// if we have aces and our sum is > 21, set some/all of them to the value 1
			//instead.
